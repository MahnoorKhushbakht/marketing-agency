...
export default function About(){
    return(
        <div id='about' style={{ display: 'flex',flexDirection:'column', position: 'relative', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <ChakraProvider>
        <Container marginTop='200px'  color='white' height='100vh' width='70%' centerContent>
        <VStack>
